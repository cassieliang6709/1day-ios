...
const pages = [['/', 'en', 'index.html'], ['/zh', 'zh', 'zh.html'], ['/privacy', 'en', 'privacy.html'], ['/zh/privacy', 'zh', 'zh/privacy.html'], ['/updates', 'en', 'updates.html'], ['/zh/updates', 'zh', 'zh/updates.html']];
const metadata = {
...
await writeFile(resolve(dist, 'sitemap.xml'), `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>${origin}/</loc></url><url><loc>${origin}/zh</loc></url><url><loc>${origin}/privacy</loc></url><url><loc>${origin}/zh/privacy</loc></url><url><loc>${origin}/updates</loc></url><url><loc>${origin}/zh/updates</loc></url></urlset>\n`);
