...
> **2026-09-07：历史审核草稿，请勿整份复制提交。** 当前版本已有可选远程题目建议，文中“零 URLSession / 无第三方服务器 / 单人模式一个字节都不上传”不再准确。请使用 `ios/release/1.2/AppStoreMetadata.md` 的新上架文案，并在提交前按发布构建复核隐私问卷与审核备注。
